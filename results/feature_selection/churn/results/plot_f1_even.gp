...
plot \
"F1_Score_set_3.csv" using 16:3 w l title "Longterm = 4" ls 1, \
"F1_Score_set_3.csv" using 16:5 w l title "Longterm = 6" ls 2, \
"F1_Score_set_3.csv" using 16:7 w l title "Longterm = 8" ls 3, \
"F1_Score_set_3.csv" using 16:9 w l title "Longterm = 10" ls 4, \
"F1_Score_set_3.csv" using 16:11 w l title "Longterm = 12" ls 5, \
"F1_Score_set_3.csv" using 16:12 w l title "Longterm = 14" ls 6, \
"F1_Score_set_3.csv" using 16:15 w l title "Longterm = 16" ls 7, 
